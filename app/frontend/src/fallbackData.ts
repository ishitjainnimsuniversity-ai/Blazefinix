// Auto-generated offline & public deployment fallback data for Blazefinix
export const FALLBACK_TOP_CANCERS = {
...
export const FALLBACK_REAL_PATIENTS = {
  "total_patients": 10,
  "males": [
    {
  ...
  "females": [
    ...
    },
    {
      ...
      "hybrid_risk_score": 0.648,
      "risk_tier": "HIGH RISK",
      "risk_color": "#F97316",
      "classical_prob": 0.672,
      "quantum_prob": 0.612,
    ...
    },
    {
      ...
      "hybrid_risk_score": 0.671,
      "risk_tier": "HIGH RISK",
      "risk_color": "#F97316",
      "classical_prob": 0.695,
      "quantum_prob": 0.635,
...
export const FALLBACK_ARCHITECTURE_USP = {
...
export const FALLBACK_BENCHMARK = {
  ...
  "feature_importances": [
    ...
    {
      "feature": "family_history_cad",
      "importance": 0.0346,
      "original_index": 14
    },
    {
      "feature": "resting_heart_rate",
      "importance": 0.0333,
      "original_index": 11
    },
    {
  ...
  "models_comparison": [
    {
      ...
      "generalization_gap": 0.0127,
      "overfitting_status": "Healthy Generalization",
      "is_winner": true
    },
    {
      "model_name": "Random Forest",
      "architecture": "CLASSICAL_TREE",
      "accuracy": 0.9083,
      "sensitivity": 0.9902,
      "specificity": 0.4444,
      "f1_score": 0.9484,
      ...
      "pr_auc": 0.9857,
      "training_time": 0.121,
      "inference_time_ms": 0.065,
      "generalization_gap": 0.073,
      "overfitting_status": "Healthy Generalization",
      "is_winner": false
    },
    {
      ...
      "pr_auc": 0.9902,
      "training_time": 0.111,
      "inference_time_ms": 0.049,
      "generalization_gap": 0.0506,
      "overfitting_status": "Healthy Generalization",
      "is_winner": false
    },
    {
      ...
      "pr_auc": 0.9879,
      "training_time": 2.081,
      "inference_time_ms": 0.054,
      "generalization_gap": 0.0686,
      "overfitting_status": "Healthy Generalization",
      "is_winner": false
    },
    {
      "model_name": "Variational Quantum Classifier (4 Qubits)",
  ...
  "hybrid": {
    ...
    "roc_auc": 0.9314,
    "pr_auc": 0.9879,
    "combination_strategy": "P_hybrid = 0.6 * P_xgb + 0.4 * P_vqc",
    "confusion_matrix": {
      "true_negative": 9,
      "false_positive": 9,
      "false_negative": 3,
